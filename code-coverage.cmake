    ...
    if(NOT LLVM_COV_PATH)
      ...
      execute_process(COMMAND "${LLVM_COV_PATH}" --version
        OUTPUT_VARIABLE LLVM_COV_VERSION_CALL_OUTPUT
			  ERROR_VARIABLE LLVM_COV_VERSIOIN_CALL_ERROR
			  COMMAND_ECHO STDOUT
				ECHO_OUTPUT_VARIABLE
				ECHO_ERROR_VARIABLE)
			message(STATUS "LLVM_COV_VERSION_CALL_OUTPUT: x${LLVM_COV_VERSION_CALL_OUTPUT}x")
			message(STATUS "LLVM_COV_VERSION_CALL_ERROR: x${LLVM_COV_VERSION_CALL_ERROR}x")

			# This is a hack, because for whatever reason, calling `llvm-cov --version` doesn't work from
			# CMake, but works fine from the commandline.
			if(NOT LLVM_COV_VERSION_CALL_OUTPUT)
      ...
      string(REGEX MATCH "[0-9]+\\.[0-9]+\\.[0-9]+" LLVM_COV_VERSION
        ${LLVM_COV_VERSION_CALL_OUTPUT})
			...
			message(STATUS "LLVM COV_VERSION: x${LLVM_COV_VERSION}x")
